...
pub const NFA = struct {
    ...
    pub fn compile(self: *NFA, node: *const Node) !struct { start: u32, accept: u32 } {
        switch (node.*) {
            .literal => |ch| {
    ...
    fn compileRepetition(self: *NFA, child: *const Node, bounds: ast.RepetitionBounds) !struct { start: u32, accept: u32 } {
